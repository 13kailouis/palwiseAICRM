...
function Section({
  ...
  return (
    <details
      className="pw-settings-section"
      open={title === "Identitas & gaya bicara"}
    >
      <summary>
        <span className="pw-settings-icon">
          {ikon && <Ikon nama={ikon} size={19} />}
        </span>
        <span className="min-w-0 flex-1">
          <span className="pw-settings-title">{title}</span>
          {ringkas && (
            <span className="pw-settings-description">{ringkas}</span>
          )}
        </span>
        {terkunci && <span className="pw-settings-lock">{terkunci}</span>}
      ...
      <div className="pw-settings-content">
        {detail && (
          <p className="mb-5 text-sm leading-relaxed text-ink-500">{detail}</p>
        )}
...
export function AgentForm({
  ...
  return (
          ...
          poin={[
            {
              ...
              teks: (
                <>
                  Atur peran, gaya komunikasi, dan batas tugas asisten. Buka
            ...
            },
            {
              ...
              teks: (
                <>
                  Simpan perubahan, lalu uji jawabannya sebelum menyambungkan
                  WhatsApp.
                </>
              ),
            },
    ...
    >
      <form
        action={formAction}
        className="pw-agent-form space-y-3"
      ...
      >
        ...
        <Section
          ikon="asisten"
          title="Identitas & gaya bicara"
          ringkas="Nama, peran, dan sapaan untuk pelanggan."
          detail="Jelaskan peran asisten, cara menyapa, dan informasi yang perlu ditanyakan kepada pelanggan."
        >
          <div>
            ...
            <p className="hint max-w-prose">
              Buat catatan kamu sendiri, pelanggan tidak melihat ini.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="hint max-w-prose flex items-center gap-2">
              <span>
                Tulis pakai bahasa sehari-hari, siapa dia dan mau bersikap
                seperti apa.
              </span>
              <InfoTip label="Lihat contoh" judul="Contoh cara nulisnya">
                <span className="block space-y-2">
                  ...
                  <span className="block">
                    ...
                    &ldquo;Kamu resepsionis Klinik Sehat Bunda, namanya Dina.
                    Sopan dan menenangkan. Bantu pasien tahu jadwal dokter dan
                    cara daftar, jangan pernah memberi saran medis.&rdquo;
                  </span>
                </span>
              </InfoTip>
            </p>
          ...
          <div>
            ...
            />
            <p className="hint max-w-prose">
              Dikirim sekali saat ada orang chat pertama kali. Kosongkan kalau
              tidak mau pakai.
            </p>
          </div>
          ...
          <Toggle
            name="isActive"
            label="Aktifkan asisten"
            hint="Nonaktifkan untuk menyerahkan semua balasan kepada tim."
        ...
        <Section
          ikon="chat"
          title="Nada & respons pelanggan"
          ringkas="Pilih gaya komunikasi yang sesuai dengan bisnismu."
        ...
        <Section
          ikon="kendali"
          title="Alihkan ke tim"
          ringkas="Tentukan situasi yang perlu ditangani langsung oleh tim."
        ...
        >
          <div>
            <label className="label" htmlFor="handoffCondition">
              Kapan tim perlu mengambil alih
            </label>
            <textarea
              id="handoffCondition"
            ...
            />
            <p className="hint max-w-prose">
              Contoh: &ldquo;Kalau pelanggan sudah kirim bukti transfer, nanya
              harga grosir, atau komplain berat.&rdquo;
            </p>
          </div>
        </Section>
        ...
        <Section
          terkunci={
            boleh("sapaOtomatis") ? undefined : paketUntuk("sapaOtomatis")
          }
          ikon="sapa"
          title="Tindak lanjut calon pelanggan"
          ringkas="Calon pembeli yang nanya-nanya lalu diam, disapa lagi otomatis."
          detail="Atur tindak lanjut untuk calon pelanggan yang belum menyelesaikan pembelian."
        >
          <Toggle
            ...
            <>
              <div className="grid max-w-sm grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  />
                  <p className="hint max-w-prose">
                    Kali. Jangan kebanyakan, nanti dianggap ganggu.
                  </p>
                </div>
              </div>
              <div>
        ...
        <Section
          ...
          ringkas="Atur pesan lanjutan untuk pelanggan yang sudah membeli."
        ...
        <Section
          ...
          ringkas="Kirim pengingat untuk jadwal yang sudah disetujui tim."
          ...
          {pengingat && (
            <>
              ...
              <div>
                ...
                />
                <p className="hint max-w-prose">
                  Hari dan jamnya disuapkan ke asisten dalam bentuk jadi, jadi
                  dia tidak perlu menghitung sendiri dan tidak bisa salah
                  menyebut tanggal.
                </p>
              </div>
            </>
        ...
        <Section ikon="kirim" title="Cara membalas">
          ...
          <div className="grid max-w-sm grid-cols-2 gap-4">
            ...
            <div>
              ...
              />
              <p className="hint max-w-prose">
                Isi 0 kalau mau balas langsung. 25 terasa wajar.
              </p>
            </div>
          </div>
        </Section>

        <SaveBar state={state} label="Simpan pengaturan" />
      </form>
    </FormDuaKolom>
  );
}
